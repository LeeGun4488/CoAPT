...
<div align="center">
  <img src="figs/domain.png" width="50%" />
</div>
...
Our code is based on [CoOp, CoCoOp](https://github.com/KaiyangZhou/CoOp), [KgCoOp](https://github.com/htyao89/KgCoOp), [MaPLe](https://github.com/muzairkhattak/multimodal-prompt-learning), [PromptSRC]([https://github.com/muzairkhattak/multimodal-prompt-learning](https://github.com/muzairkhattak/PromptSRC)) and [DePT](https://github.com/Koorye/DePT) repositories. We thank the authors for releasing their code. If you use our model and code, please consider citing these works as well.
